...
- 🎯 **Автоматическая категоризация** - идеи, жизнь, работа, инбокс
- 📝 **Структурированный markdown** - заголовки, списки, форматирование
- 🧹 **Очистка речи** - удаление слов-паразитов
...
3. **Начните с категории**: "идеи ...", "работа ...", "жизнь ..."
4. Получите структурированную заметку!

**Пример:**
> 🎙️ "Работа. Нужно созвониться с командой по поводу нового проекта завтра в 10 утра. Обсудить архитектуру и сроки."
...
| `/move <файл> <категория>` | Перемещение заметки |
