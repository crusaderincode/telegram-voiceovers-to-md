...
- AI модели (Whisper large-v3, Qwen 2.5:3b, nomic-embed-text)
- whisper.cpp с оптимизацией для M1
- Базу данных для поиска (Qdrant)
...
6. Теперь вы можете найти эту заметку через команду `/search` или кнопку **🔍 Поиск**
